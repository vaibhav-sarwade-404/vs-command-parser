    ...
    parse() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.useProvidedArguments.length &&
                (0, validation_1.doesAtleastOneObjectContainsKeyValue)([Object.values(options), Object.values(namedOptions)], "required", true)) {
                throw new Error(`Atleast one inline or named option is required. Please run command with "help" to get more information about options`);
            }
            if (this.useProvidedArguments.length) {
